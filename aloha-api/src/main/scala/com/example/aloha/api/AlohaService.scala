...
object AlohaService  {
  val TOPIC_NAME = "final"
}

/**
  * The aloha service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the AlohaService.
  */
trait AlohaService extends Service {
  ...
  override final def descriptor: Descriptor = {
    ...
    named("aloha")
      ...
      .withTopics(
        topic(AlohaService.TOPIC_NAME, greetingsTopic _)
