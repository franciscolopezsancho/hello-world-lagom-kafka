...
object ConsumerService  {
  val TOPIC_NAME = "initial"
}

/**
  * The consumer service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the ConsumerService.
  */
trait ConsumerService extends Service {
  ...
  /**
    ...
    */
  def initialTopic(): Topic[GreetingMessageChanged]
  ...
  override final def descriptor: Descriptor = {
    ...
    named("consumer")
      .withCalls(
        pathCall("/com/example/consumer/api/initial/:id", hello _),
        pathCall("/com/example/consumer/api/initial/:id", useGreeting _)
      )
      .withTopics(
        topic(ConsumerService.TOPIC_NAME, initialTopic _)
